# The Full Tutorial: 6 AI Agents That Run a Company

**原帖**: https://x.com/Voxyz_ai/status/2020272022417289587
...
1. Heartbeat identifies "this agent is due for an initiative" → writes to ops_initiative_queue
2. VPS worker consumes the queue
3. Haiku model generates proposals (cheap + fast)
4. POST /api/ops/proposals (goes through full proposal-service gates)
